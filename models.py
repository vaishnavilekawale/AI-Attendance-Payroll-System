...
class Payroll(db.Model):
    ...
    full_basic_salary = db.Column(db.Float, default=0.0)
    full_hra = db.Column(db.Float, default=0.0)
    full_da = db.Column(db.Float, default=0.0)
    full_medical_allowance = db.Column(db.Float, default=0.0)
    full_travel_allowance = db.Column(db.Float, default=0.0)
    full_special_allowance = db.Column(db.Float, default=0.0)
    full_other_allowances = db.Column(db.Float, default=0.0)
